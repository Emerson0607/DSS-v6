Sub Update_Above()
    ...
    For i = 1 To lastRow
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Literacy" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Literacy" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
                Cells(i, 16).Value = "Digital Literacy Training"
            ElseIf Cells(i, 3).Value = "Elementarya" Then
        ...
        '########################### Socio-economic #################################
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Socio-economic" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Socio-economic" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
                Cells(i, 16).Value = "Entrepreneurship Bootcamp"
            ElseIf Cells(i, 3).Value = "Elementarya" Then
                Cells(i, 16).Value = "Microenterprise Development Fund"
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Environmental Stewardship" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Environmental Stewardship" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        '########################### Health and Wellness #################################
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Health and Wellness" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Health and Wellness" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
                Cells(i, 16).Value = "Nutrition Program"
            ElseIf Cells(i, 3).Value = "Elementarya" Then
                Cells(i, 16).Value = "Community Fitness Classes"
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Cultural Enhancement" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Cultural Enhancement" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
                Cells(i, 16).Value = "Intercultural Dialogue Workshops"
            ElseIf Cells(i, 3).Value = "Elementarya" Then
                Cells(i, 16).Value = "Indigenous Cultural Exchange"
        ...
        '########################### Values Formation #################################
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Values Formation" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Values Formation" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
            ...
            ElseIf Cells(i, 3).Value = "Kolehiyo" Then
                Cells(i, 16).Value = "Career Development and Values Alignment"
            ElseIf Cells(i, 3).Value = "Masters Degree" Then
        ...
        '########################### Disaster Management #################################
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Disaster Management" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Disaster Management" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "May Trabaho" And Cells(i, 15).Value = "Gender and Development" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
        ...
        If Cells(i, 2).Value = "65-Above" And Cells(i, 4).Value = "Walang Trabaho" And Cells(i, 15).Value = "Gender and Development" Then
            If Cells(i, 3).Value = "Hindi nakapagtapos ng Elementarya" Then
                Cells(i, 16).Value = "Advocacy campaigns against gender-based violence"
            ElseIf Cells(i, 3).Value = "Elementarya" Then
                Cells(i, 16).Value = "Orientation and Anti-Sexual and Safe Spaces"
